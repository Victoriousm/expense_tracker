<template>
  <div class="w-full px-2 sm:px-6 py-4 sm:py-6">
    ...
    >
      ...
      <div v-else class="overflow-x-auto scrollbar-hide">
        ...
        >
          <thead>
            <tr
              class="bg-gray-50 border-b border-gray-100 dark:bg-slate-900/50 dark:border-gray-900"
            >
              <th
          ...
          <tbody class="divide-y divide-gray-50 dark:divide-gray-700">
            ...
            >
              <td
                class="p-3 sm:p-4 text-xs sm:text-sm text-gray-600 dark:text-gray-300 whitespace-nowrap"
              >
                {{ item.date }}
              </td>
      ...
      >
        ...
        >
          ...
          <span class="ml-2 text-indigo-500"
            >({{ filteredExpenses.length }} total expenses)</span
          >
        </p>
    ...
    >
      <div
        class="dark:bg-slate-800 bg-white rounded-2xl sm:rounded-3xl p-5 sm:p-8 max-w-lg w-full shadow-xl"
      >
        <h3
          class="dark:text-white text-xl sm:text-2xl font-black text-indigo-600 mb-6 uppercase"
        >
          Edit Expense
        </h3>
        <form @submit.prevent="saveEdit" class="space-y-4">
          ...
          <div class="flex gap-3 pt-4">
            ...
            <button
              type="submit"
              class="flex-1 py-3 bg-indigo-600 text-white rounded-xl font-bold text-sm"
            >
              Save Changes
            </button>
          </div>
